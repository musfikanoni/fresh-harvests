...
export default function SpecialOffer() {
  return (
    <div className='special h-[75vh] lg:w-[1140px]'>
      <div className="mx-auto max-w-7xl">
        ...
        <span className='bg-[#176D38] my-5 px-5 py-3 rounded-full font-extrabold'>CODE : <span className='text-warning'>FRESH28</span></span>
      </div>
